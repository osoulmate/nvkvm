...
class CopyRight extends JFrame
{
  ...
  public CopyRight() {
    ...
    Image image = (new ImageIcon(this.getClass().getClassLoader().getResource("images/vconsole.png"))).getImage();
    setIconImage(image);
    setResizable(false);
  ...
  public void init() {
    ...
    Image image2 = (new ImageIcon(this.getClass().getClassLoader().getResource("images/logo.jpg"))).getImage();
