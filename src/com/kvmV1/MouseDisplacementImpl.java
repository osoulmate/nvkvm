...
import com.newKvm.MouseDisplacement;
public class MouseDisplacementImpl
{
  ...
  public static int keyBoardEncrypt(byte[] inputBuf, byte[] outputBuf, int len, int keyCode) {
    if (KVMUtil.isLinuxOS())
    {
      return 0;
    }
    return MouseDisplacement.keyBoardEncrypt(inputBuf, outputBuf, len, keyCode);
  }
